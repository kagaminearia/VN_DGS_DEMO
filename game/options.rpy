...
define config.name = _("DreamyGoldenSnow-DEMO")
...
## Add extra sound channels
init python:
    renpy.music.register_channel("dictionary", "sfx", True)
...
define config.main_menu_music = "audio/bgm/dream.mp3"
