...
label ch0:
    ...
    "——嗯？！"
    "短暂的眩晕后，眼前的场景变了。"
    "仍然很黑，尽管不是漆黑一片，但在这样的环境下，我也只能勉强确认这里是室内，是一个密闭的房间。"
    "房间没有开灯，什么都看不清楚，仿佛一切都被吞噬。"
    "这似乎是个完全陌生的地方。"
    "而我并不清楚发生了什么。"
    by eye_still e "什么，情况，啊……"
    "……………………………………"
    "………………嗯……？"
    "——刚才的，不是我自己的声音。"
    ...
    "所以房间里还有另一个人存在？"
    "可我却完全没注意到……怎么回事？"
    "太黑了，什么都看不见，即使知道有人也不知道她在哪……我顿时收紧了心神。"
    "陌生的环境，不知为何出现的另一个人……我的心脏跳得很快，几乎要窒息了。"
    "不行，冷静……"
    "……"
    "僵持在此也不是个办法……不知为何，我完全无法控制身体，只能先试试跟她交流了。"
    me "………………还有人，吗？"
    by eye_shock o "{size=45}谁在说话？！{/size}"
    scene bg_sickroom with vpunchm
    "视线猛地晃动一下，随后，变得明显的呼吸声传来，有些急促。"
    "她似乎比我更加慌张，声音微颤。"
    "所以她也不知道我的存在……至少，她应该不是始作俑者……"
    "但，这到底是什么情况……"
    by eye_shock e "还有人在这里？{size=23}声音很近……{/size}"
    scene bg_sickroom with vpunchm
    ...
    by eye_wacky o "我听见了。有人是吗，躲哪了，为什么我看不见你？"
    "她的声音稍微提高一些，带动胸腔的震颤。"
    "刚缓和一些的心脏更加剧烈地快速跳动，她抬起手按在胸口，试图安抚。"
    "等等，不对……这感觉……"
    "不知道是错觉，还是黑暗和陌生的环境影响，憋闷感逐渐出现，令人难受。"
    by eye_squint o "……哈，喂……说话啊……"
    "经过几次大喘气，她好不容易让自己从恐惧中冷静下来。"
    "……而我也终于确认了我的感觉。"
    me "我……你，嗯……"
    "纠结好一会，我静静感受完，才斟酌开口。"
    me "似乎……有可能……我现在，在你的身体里？"
    by eye_shock o "{size=45}什么？你在说什么鬼话？{/size}"
    scene bg_sickroom with vpunchm
    "刷地一声，她猛地站起来。动作太猛，以至于她有些发软的双腿差点没能站稳。"
    by eye_shock e "咳咳……你再说一遍？"
    me "你不觉得……我的声音在你脑子里吗？"
    "虽然我已经基本上确定了，但我的惊讶可一点不比她的少。"
    "我不敢相信，却似乎又不得不相信。"
    "剧烈的心跳不是我的，而是她的。紧张和恐惧的心情也一样。"
    "她说话时，声音就好像从我自己胸口发出，传到外界……"
    by eye_wacky def "……"
    "她陷入沉默，没有说话。"
    "……"
    me "呃……你要不要……"
    "突然，在我以为她陷入混乱的时候，她猛地从口袋里抽出什么。"
    show blood1 onlayer ontop with Dissolve(0.1)
    stop music
    pause 0.1
    hide blood1 onlayer ontop
    me "噫——？！"
    "她的手指紧紧地捏着一根笔杆，而后用力地划过左臂。"
    me "啊……？"
    ...
    by eye_wacky def "{size=23}应该不是做梦，梦里一般不会痛的……{/size}"
    by eye_shock o "………………{size=23}所以是我终于疯了？{/size}"
    ...
    me "……"
    "怎么还带骂人的？这绝对是在骂人吧？"
    "好吧……突然遇到这种事，她这么想也很正常……吧？"
    "但是，我也很无奈啊……"
    "事实上，我什么都不记得。睁开眼的一瞬间，我就这样出现在这里，看到她，或者说……跟在她身上。"
    ...
    me "……我不知道……"
    by eye_wacky o "哈？？？"
    me "我真的不知道啊……别的我什么都不记得，听到你的声音的时候就在这里了。"
    by eye_move e "哦……好吧。{p}我知道了，你比我还没用。"
    me "……"
    "你才没用。"
    by eye_def o "好吧，那你有什么是知道的。"
    me "你身上的事，难道不应该问你自己吗？"
    by eye_move e "我，呃，我也不记得……{p}不知道为什么。我明明记得之前还在家里睡觉啊，睡醒之后就在这里了。"
    "被我这么问，她顿时没了之前的咄咄逼人，大概是自觉理亏。"
    "等她的话说完，我们双双陷入沉默。"
    ...
    me "你不应该反思一下这种事为什么偏偏发生在你身上吗？"
    by eye_wacky o "哈？我为什么要反思？如果我跟你之中有一个人有问题，那绝对是你有问题。"
    me "啊？凭什么啊？"
    by eye_still e "这有什么凭什么？我肯定是替自己说话啊。"
    me "……"
    "这话……说得还挺有道理。\n……如果我不是那个被怪的人就更好了。"
    ...
    "……"
    "花了一段时间接受现实。"
    "既然我们被强行联系在一起，至少要互相熟悉一下……"
    me "合作共赢啊合作共赢……"
    by eye_def e "切……好吧……我知道了。"
    ...
    "在那之后，不知道他们又发现了什么，不再有人拿着枪对准白一，只是仍然不让她从这里出去。"
    ...
    xp "刚才的事很抱歉，但你应该知道为什么。我们现在有些问题想要问你。"
    by eye_def o "什么……？我怎么知道？"
    "白一似乎完全不懂，但并不能阻拦对方继续说话。"
    hide xpimg
    show xpimg at char_mid
    "但，不管怎么说，她突然出现在这里，还失去意识，无论怎么想都十分奇怪，对方要询问也是理所当然。"
    "最重要的是，无论如何，在这个地方，白一并没有反抗的能力和资格……"
    hide xpimg
    show xpimg o at char_mid
    xp "前天的下午和晚上，你在哪里，在做什么？前天，12月10日。"
    by eye_def o "……12月10号？是……"
    "白一愣了愣，尽力含糊其辞——我知道，她是不记得之前的事情了。"
    me "今天是12月12号，星期日。\n噢，是我“看见”的。"
    "放在桌子下的右手悄悄移动，放在左臂上。白一用力按了按伤口，大概是表示她听到了我的话。"
    by eye_move o "嗯，周五的时候，我……应该在家。"
    xp "是吗？有人看到你下午经过晟欧路路口。"
    by eyes_still o "那——可能是我记错了……"
    ...
    "房间里陷入沉默，但意外的是，这次对面的人并没有在第一时间驳斥白一。"
    "她只是拧起了眉毛，看着白一，似乎在等她继续说下去。"
    "没得到反应，白一吞了吞口水，只好轻轻地、缓缓地吐出一口气。"
    by eye_def o "呃，就是，我只记得周四的时候，我跟平时一样上学放学，晚上在家里睡觉。"
    by eye_still o "然后，睡着，醒来之后……就是刚才了。"
    hide xpimg
    show xpimg o at char_mid
    xp "之前的事情全部还记得，只有这两天的事忘了？"
    by eye_def e "嗯……对。就是从，那天开始。"
    xp "那么，周四没有发生过其他事情吗？任何不确定的细节都可以。"
    by eye_def def"……没有。"
    "短发女人没再说话，安静地坐在凳子上，似乎在思考着什么。"
